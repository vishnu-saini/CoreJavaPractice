...
public class Main {
	...
	public static void main(String args[]) {
		...
		String dicision, productToBeDeleted;
		...
		productBO.displayAllProductDetails(productList);

		System.out.println("Enter the name of the product to be deleted");
		productToBeDeleted = scanner.nextLine();
		productBO.deleteProduct(productList, productToBeDeleted);
		productBO.displayAllProductDetails(productList);
	}
}
